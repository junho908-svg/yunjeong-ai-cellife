...
export default function YunjeongAICellife() {
  ...
  const newsItems = [
    {
      type: "마음노트",
      title: "이상하게 만나고 오면 기분 좋아지는 사람들의 특징 5가지",
      summary: "특별한 일을 한 것도 아닌데, 만나고 오면 마음이 가벼워지는 사람이 있습니다. 끝까지 들어주고, 함께 있으면 나도 괜찮은 사람이 되고, 작은 배려를 당연하게 하고, 나를 바꾸려 하지 않고, 헤어진 뒤에도 따뜻함이 남는 사람 — 잘난 사람보다 마음을 편하게 해주는 사람이 더 오래 남는다는 잔잔한 감성 에세이입니다.",
      source: "네이버 블로그 (달빛감정노트)",
      date: "2026-06-05",
      url: "https://m.blog.naver.com/dalbit_mood/224307080136",
      detail: {
        lead: "특별한 이야기를 나눈 것도, 엄청 즐거웠던 것도 아닌데 집으로 돌아오는 길이 이상하게 가벼운 사람이 있습니다. 그런 '만나고 오면 기분 좋아지는 사람들'의 다섯 가지 공통점을 짚은 감성 에세이입니다.",
        sections: [
          { h: "기분 좋아지는 사람들의 특징 5가지", items: ["내 이야기를 끝까지 들어준다 — 중간에 끊지 않고, 정답을 강요하지 않고, 충고보다 먼저 경청한다", "함께 있으면 나도 괜찮은 사람이 된다 — 긴장하지 않아도, 조금 부족해도 편안하다", "작은 배려를 당연하게 한다 — 우산을 챙겨주고 따뜻하게 답장하는, 사소하지만 오래 기억되는 배려", "나를 바꾸려 하지 않는다 — 틀린 점을 찾기보다 있는 그대로 이해하려 한다", "헤어진 뒤에도 따뜻함이 남는다 — 잘난 척하지 않고, 비교하지 않고, 존중해 준다"] },
          { h: "우리에게 주는 의미", items: ["사람들이 오래 기억하는 건 '대단한 사람'이 아니라 '마음을 편하게 해준 사람'이다", "곁의 사람을 대하는 작은 태도가, 결국 관계와 신뢰를 오래 남긴다"] },
        ],
      },
    },
    {
      type: "인사이트",
      title: "이호선 교수가 분석한 '인생 잘 풀리는 사람'의 3가지 비밀",
      summary: "인생이 잘 풀리는 사람들의 공통점은 타고난 운이 아니라 매일의 마음 습관이라는 이호선 교수의 분석입니다. 가진 것을 헤아리는 진짜 긍정성, 남에게서 배울 점을 찾는 유연함, 나 자신의 기쁨·성장에 집중하는 태도를 핵심으로 짚습니다.",
      source: "네이버 블로그 (하늘빛)",
      date: "2026-05-30",
      url: "https://m.blog.naver.com/lyj5760/224300656219",
      detail: {
        lead: "인생의 성패를 가르는 결정적 차이는 타고난 운명이 아니라 '매일을 살아가는 마음의 습관과 에너지를 쓰는 방향'이라는 이호선 교수의 심리 분석입니다.",
        sections: [
          { h: "인생 잘 풀리는 사람의 3가지 비밀", items: ["진짜 긍정성 — 막연한 낙천이 아니라, 이미 가진 것과 작은 가능성을 헤아려 기회로 바꾸는 해석 능력", "배움의 유연함 — 남을 깎아내리는 대신 타인의 장점·성공에서 배울 점을 찾아 흡수한다", "나 자신에 집중 — 타인의 시선 대신 나의 기쁨·성장에 에너지를 쏟는다"] },
          { h: "함께 강조한 태도", items: ["머무는 자리와 말의 수준을 바꾸는 결단 — 부정적 환경에서 벗어나 긍정적 자극(책·건강한 사람)을 곁에 둔다", "결국 삶의 주권은 나에게 있다 — 환경·타인 탓 대신 내 에너지의 방향을 바꾼다"] },
          { h: "우리에게 주는 의미", items: ["작은 관점·습관의 변화가 결국 인생의 큰 차이를 만든다"] },
        ],
      },
    },
    {
      type: "인사이트",
      title: "돈 많은 사람들의 공통 사고방식 — 기준 · 선택 · 원칙 · 단순함",
      summary: "돈 많은 사람들이 공통적으로 가진 사고방식을 정리한 글입니다. 기준이 명확해 고민이 짧고, 할 일과 안 할 일을 분명히 나눠 선택을 줄이며, 감정보다 원칙으로 움직이고, 복잡한 것을 단순하게 보는 능력 — 결국 단순함이 더 빠르고 안정적인 결과를 만든다는 재테크·자기계발 인사이트입니다.",
      source: "네이버 블로그",
      date: "",
    ...
    {
      type: "인사이트",
      title: "나를 바꾼 작은 순간들 · 인간관계 단단한 사람 · 성공하는 7가지",
      summary: "삶을 단단하게 만드는 작은 습관들, 인생이 풀리기 시작하는 징조, 흔들리지 않고 자기 중심이 있는 사람의 인간관계 태도, 그리고 '일단·꾸준히·될 때까지' 같은 성공의 기본기를 모은 자기계발 글입니다. 비교 대신 나만의 길을 지키자는 메시지를 담았습니다.",
      source: "네이버 블로그 (더치콩)",
      date: "2026-06-13",
  ...
  const beautyLessons = [
    ...
    { t: "셀비아 스프레이 촉촉 홈케어", ep: "LESSON 3", lvl: "기본", yt: "IX8IldsxDRQ",
      detail: { lead: "그냥 얼굴에만 뿌리고 끝내지 않도록, 앰플 세팅부터 부위별 방향까지 8단계로 촉촉하게 사용하는 법을 시연합니다.",
        sections: [
          { h: "8단계 사용 순서", items: ["앰플 장착·세팅 → 얼굴 전체 수분 레이어링 (15~20cm 거리)", "목·턱은 위에서 아래로, 귀 주변 라인 케어", "볼은 코 옆에서 광대 바깥으로, 이마는 눈썹 위에서 헤어라인 방향으로", "예민한 눈가·입가는 둥글게 감싸며 자극 없이 분사"] },
          { h: "포인트", items: ["분사 거리와 방향 지키기", "아침 · 저녁 데일리 루틴으로 반복"] },
        ] } },
    { t: "슈스펠 4-in-1 디바이스 사용법", ep: "LESSON 4", lvl: "기본", yt: "p-qo7bFPaeE",
